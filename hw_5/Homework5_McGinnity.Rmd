...
```{r chart}
baltimore_monthly_homicides_plot <- baltimore_monthly_homicides %>%
  ggplot(aes(x = date,
               y = homicides)) + 
...
```{r save_figure}
ggsave("baltimore_monthly_homicides_plot.png", plot = baltimore_monthly_homicides_plot, width = 9, height = 2.67, units = "in", dpi = 300)
```
